...
export default function EditNecessidade() {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                const response = await fetch(`${API_BASE_URL}/necessidades/${params.id}`, {
                    headers: { 'Authorization': `Bearer ${token}` }
                });
                if (!response.ok) {
                    window.alert(`Erro ao buscar necessidade: ${response.statusText}`);
                    return;
                }
                ...
                setForm({
                    ...
                    quantidade_desejada: record.quantidade_desejada || "",
    ...
    async function onSubmit(e) {
        ...
        try {
            ...
            window.alert("Necessidade atualizada com sucesso!");
        ...
        <div className="container-fluid py-2">
            ...
            <div className="mt-3 mb-4">
                <h3 style={{ color: primaryColor, fontWeight: 'bold' }}>
                    <i className="bi bi-box-seam-fill me-2"></i> Editar Necessidade de Doação
                </h3>
                <p className="text-muted mb-0">Atualize os dados do item necessário</p>
            </div>
